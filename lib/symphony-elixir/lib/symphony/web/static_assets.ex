defmodule Symphony.Web.StaticAssets do
  @moduledoc false

  # Embed the dashboard CSS and Phoenix JS shims at compile time so the
  # operator dashboard works without a separate asset pipeline (no esbuild,
  # no priv copy). All bundles are short — under 200KB combined — and
  # change rarely.
