defmodule Mix.Tasks.Specs.Check do
  ...
  Mirrors upstream `Mix.Tasks.Specs.Check`. Distinct from
  `mix symphony.spec_compliance`, which is a runtime
  behavioural-conformance check rather than a static linter.

  Usage:

      mix specs.check
      mix specs.check --paths lib --paths test/support
